...
export function initDb() {
  db.exec(`
    CREATE TABLE IF NOT EXISTS users (
      ...
      role TEXT NOT NULL CHECK (role IN ('assessor', 'administrator')),
  ...
  if (count === 0) {
    ...
    insert.run('Admin User', 'admin@mrs.local', bcrypt.hashSync('admin123', 10), 'administrator');
    insert.run('Assessor User', 'assessor@mrs.local', bcrypt.hashSync('assessor123', 10), 'assessor');
  }
